...
2. An unsolved bug I have is when I display the footer details as a column the quick links section wasn't aligning with the other two lists, this happens @ 550px screen width. I have tried multiple methods to display this that haven't worked, the only fix I could find was making the margin right 200px.That seems to have worked but I don't want to code it that way in the future as to me it seems a lazy way to do it. I'd love to improve on things like this.
